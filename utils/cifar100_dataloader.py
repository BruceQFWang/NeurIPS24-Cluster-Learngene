...
class DataLoader(object):
    ...
    def __init__(self, dataset, batch_size=1, epoch_size=None, num_workers=0, shuffle=True):
...
'''def get_cifar_x(batch_size, path):
    transforms_list = [
    ...
    dataset_train = datasets.ImageFolder(path, transforms.Compose(transforms_list))
    dataloader_train = DataLoader(dataset_train, batch_size, epoch_size = None, num_workers = 0, shuffle = True)
...
def get_permute_cifar100(num_tasks, batch_size, subtask_classes_num, num_imgs_per_cate, path):
    ...
    for i in range(num_tasks):
        ...
        dataloader_train[i] = DataLoader(dataset_train, batch_size, epoch_size = None, num_workers = 0, shuffle = True)

    return dataloader_train



def get_val_cifar100(num_tasks, batch_size, subtask_classes_num, num_imgs_per_cate, path):
    ...
    for i in range(num_tasks):
        ...
        task_folder_path = os.path.join( path )
    ...
    for i in range(num_tasks):
        ...
        dataloader_test[i] = DataLoader(dataset_test, batch_size, epoch_size = None, num_workers = 0, shuffle = True)
...
def get_inheritable_cifar100_84(num_tasks, batch_size, subtask_classes_num, num_imgs_per_cate, path):
